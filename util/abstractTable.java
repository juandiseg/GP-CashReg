...
public class AbstractTable {
     ...
     * 
     * @param panel panel where the table will go
     ...
     */
    public AbstractTable(JPanel panel, int order_id, ArrayList<OrderItems> orderItems, ArrayList<OrderMenus> orderMenus) {
     ...
     * If it's clickable you will be able to change the quantnity of the products or delete them
